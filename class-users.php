...
class Users {
  ...
  public function addUser($userName, $userPassword) {
    ...
    if (file_exists ("users/$userName.csv")) {
      echo "<h3 class='message red'>Denna användaren finns redan</h3>";
    }
    else {
      echo "<h3 class='message green'>Du är nu registrerad</h3>";
  ...
  public function login($userName, $userPassword) {
    ...
    if (file_exists ("users/$userName.csv")) {
      ...
      if ($userName == $userFile[0][0] && $isCorrect) {
        ...
        echo "<h3 class='message red'>Felaktigt Lösenord</h3>";
      }

    }
    else {
      echo "<h3 class='message red'>Felaktigt Användarnamn</h3>";
    }
